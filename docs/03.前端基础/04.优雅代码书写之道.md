---
title: 优雅代码书写之道
date: 2022-06-07 13:14:24
permalink: /pages/e6c9b7/
categories:
  - 前端基础
tags:
  - 
...
> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [github.com](https://github.com/ryanmcdermott/clean-code-javascript)

> :bathtub: Clean Code concepts adapted for JavaScript - ryanmcdermott/clean-code-javascript: Clean Cod......
...
[![](resources/dd7e9b6a3851416ab4b4c26086a2cdba.jpg)](https://camo.githubusercontent.com/af72fb10accee2e9a59efec2a0b436242fad5bb2a00ca11494e7c759834625cc/68747470733a2f2f7777772e6f736e6577732e636f6d2f696d616765732f636f6d6963732f7774666d2e6a7067)
...
### [](#dont-add-unneeded-context)Don't add unneeded context
...
### [](#functions-should-do-one-thing)Functions should do one thing 一个函数只负责一件事

This is by far the most important rule in software engineering. When functions do more than one thing, they are harder to compose, test, and reason about. When you can isolate a function to just one action, it can be refactored easily^更加易于重构^ and your code will read much cleaner. If you take nothing else away from this guide other than this, you'll be ahead of many developers.
> 当函数所做的事超过一件时，就意味着其将会变得更加难于编写，测试和解释器用途。而当函数只做一件事会让函数变得更加易于重构和更加的整洁。
...
### [](#function-names-should-say-what-they-do)Function names should say what they do | 函数名应当更加语义化
...
> 当函数的抽象类别高于一个级别时通常说明函数所做的事情太多的，需要将其重构使其变得更加易于测试。
...
> 最好避免相同的代码通过复制粘贴导入不同的模块中。大量复制相同的代码到不同的模块内，当核心代码逻辑需要进行一些更改的时候，需要做更多的重复不比较的工作。不要为了一时复制一时爽，更改需求火葬场！

Imagine if you run a restaurant and you keep **track**^追踪^ of your **inventory**^库存^: all your tomatoes, onions, garlic, spices, etc. If you have multiple lists that you keep this on, then all have to be updated when you serve a dish with tomatoes in them. If you only have one list, there's only one place to update!
> 想象一下，如果您经营一家餐馆并跟踪您的库存：所有的西红柿、洋葱、大蒜、香料等。如果您有多个库存清单，那么当用掉了一些西红柿的时候，所有的库存清单都必须更新。但是如果只有一个列表，那么只有一个地方需要更新！

Oftentimes you have duplicate code because you have two or more slightly different things, that share a lot in common, but their differences force you to have two or more separate functions that do much of the same things. Removing duplicate code means creating an abstraction that can handle this set of different things with just one function/module/class.
> 通常有重复的代码，是因为有一些不同的地方需要修改，即使有很多共同点，但这种微小的的差异迫使你创建两个或更多独立的函数来做这些相同的事情。删除重复代码意味着创建一个抽象，它可以只用一个函数/模块/类来处理这组不同的事情。
...
// 这显然是没有必要的，这两个函数之间的差异就只有细微的不一样，可以使用抽象尽量的避免此类情况的发生
```
...
### [](#set-default-objects-with-objectassign)Set default objects with Object.assign

### 使用Object.assign来设置函数参数初始值
...
### [](#dont-use-flags-as-function-parameters)Don't use flags as function parameters
...
### [](#dont-write-to-global-functions)Don't write to global functions
...
### [](#dont-over-optimize)Don't over-optimize
...
### [](#prefer-es2015es6-classes-over-es5-plain-functions)Prefer ES2015/ES6 classes over ES5 plain functions
...
### [](#openclosed-principle-ocp)Open/Closed Principle (OCP)
...
### [](#asyncawait-are-even-cleaner-than-promises)Async/Await are even cleaner than Promises
...
### [](#dont-ignore-caught-errors)Don't ignore caught errors
...
### [](#dont-ignore-rejected-promises)Don't ignore rejected promises
...
### [](#dont-leave-commented-out-code-in-your-codebase)Don't leave commented out code in your codebase
...
### [](#dont-have-journal-comments)Don't have journal comments
