...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'xiaocao12306', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '小曹同学', // 必需
      link: 'https://github.com/xiaocao12306', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://pic-xiaocao123-1304191709.cos.ap-guangzhou.myqcloud.com/1000.jpg',
      name: '小曹同学',
      slogan: '一个普通的前端开发',
    },
